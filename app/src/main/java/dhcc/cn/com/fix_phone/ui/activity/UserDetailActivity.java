    ...
    private void initData() {
        ...
        if (mFriend != null) {
            if (mFriend.isExitsDisplayName()) {
                ...
                mUserNickName.setText("昵称:" + " " + mFriend.getName());
...
//        startActivityForResult(intent, 99);
        NToast.shortToast(this, "Hello My leader");
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ac_bt_add_friend:
                DialogWithYesOrNoUtils.getInstance().showEditDialog(mContext, getString(R.string.add_text), "确认", new DialogWithYesOrNoUtils.DialogCallBack() {
                    @Override
                        ...
                        if (mFriend.getUserId().equals(userEntity.getId())) {
                            if (hasFriendInfoChanged(resultEntity)) {
                                ...
                                if (!TextUtils.isEmpty(mFriend.getDisplayName())) {
                                    mUserNickName.setVisibility(View.VISIBLE);
                                    mUserNickName.setText("昵称:" + " " + nickName);
                                    mUserDisplayName.setText(mFriend.getDisplayName());
