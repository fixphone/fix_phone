...
public class MultiImageView extends LinearLayout {
    ...
    private ImageView createImageView(int position, final boolean isMultiImage) {
        ...
        if (isMultiImage) {
            ...
            imageView.setId(photoInfo.FOriginalUrl.hashCode());
            imageView.setOnClickListener(new ImageOnClickListener(position));
            Glide.with(getContext()).load(photoInfo.FOriginalUrl).diskCacheStrategy(DiskCacheStrategy.ALL).into(imageView);
        } else {
            imageView.setAdjustViewBounds(true);
            imageView.setScaleType(ScaleType.CENTER_INSIDE);
            imageView.setId(photoInfo.FOriginalUrl.hashCode());
            imageView.setOnClickListener(new ImageOnClickListener(position));
            Glide.with(getContext()).load(photoInfo.FOriginalUrl).listener(new RequestListener<String, GlideDrawable>() {
                @Override
