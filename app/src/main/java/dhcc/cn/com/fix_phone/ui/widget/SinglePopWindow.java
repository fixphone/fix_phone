...
import dhcc.cn.com.fix_phone.rong.SealAction;
        ...
        blacklistStatusRL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (blacklistStatus == RongIMClient.BlacklistStatus.IN_BLACK_LIST) {
                    ...
                    PromptPopupDialog.newInstance(context, "加入黑名单",
                    "你将不再收到对方消息").setPromptButtonClickedListener(new PromptPopupDialog.OnPromptButtonClickedListener() {
                        @Override
